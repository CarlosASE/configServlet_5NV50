 ...
 */
package SaldanaEnriquezCarlosAbraham;
...
public class Servlet2 extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet 2 5NV50 PROGRAMACION WEB</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet 2 - Saldaña Enriquez Carlos Abraham</h1>");
